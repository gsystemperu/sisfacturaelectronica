...
folder are mapped to the application's root namespace, 'sisfacturaelectronica'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "sisfacturaelectronica"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'sisfacturaelectronica' in the same way
as `"sisfacturaelectronica/sass/src"`.
