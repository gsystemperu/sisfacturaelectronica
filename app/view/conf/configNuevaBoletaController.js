Ext.define('sisfacturaelectronica.view.conf.configNuevaBoletaController', {
    ...
    onClickEliminar:function(b){
      ...
      if(Ext.isNumber(r.get('id')))
          sisfacturaelectronica.util.Util.ajax(sisfacturaelectronica.util.Rutas.tiendaEliminarDocumentoVenta,data,d)
      else
          d.remove(r);
    ...
    onClickGuardar:function(b){
      ...
      sisfacturaelectronica.util.Util.ajax(sisfacturaelectronica.util.Rutas.tiendaAsignarDocumentoVenta,data,d);
